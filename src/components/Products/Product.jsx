...
const Product = ({ id, title, price, rating, image }) => {
  return (
    <Link to={`/product/${id}`}>
      <div className=" hover:cursor-pointer w-[300px] hover:shadow-sm wrapper flex flex-col justify-center items-center max-w-xs rounded overflow-hidden shadow-lg sm:max-w-sm md:max-w-md lg:max-w-lg xl:max-w-xl">
